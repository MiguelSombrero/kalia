...
@Schema(description = "A single bottle owned by the caller")
public record BottleDto(
	...
	static BottleDto from(Bottle bottle) {
		return new BottleDto(bottle.getId(), bottle.getEntry().getId(), bottle.getContainerType(),
