...
**Definition of done (every issue):** tests written and green, module
boundaries verified (backend), lint/format clean, docs updated if behavior or
...
1. Monorepo layout: `backend/`, `frontend/`, `docs/`, root `docker-compose.yml` with PostgreSQL
