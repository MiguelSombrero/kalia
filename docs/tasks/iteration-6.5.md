...
| ID | Task | Status |
|---|---|---|
| [01](iteration-6.5/01-persist-keycloak-state.md) | Persist Keycloak's state across restarts | done |
...
| [17](iteration-6.5/17-reconcile-signup-restart-check-with-shared-keycloak-helper.md) | Reconcile check-signup-survives-restart.mjs with the shared Keycloak helper | done |
