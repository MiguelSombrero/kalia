...
| [05](iteration-7/05-feed-delivery-decision.md) | Decide how the feed reaches a browser that is already open | done |
...
| [07](iteration-7/07-live-front-page.md) | The front page updates without a reload | done |
...
| [11](iteration-7/11-keycloak-brute-force-protection.md) | Lockout on password guessing | done |
| [12](iteration-7/12-scope-exception-advices.md) | Scope each module's exception advice to its own module | done |
...
| [16](iteration-7/16-catalog-sort-param-degrades-to-error-boundary.md) | An out-of-set `sort` value 400s the catalog page instead of degrading | needs-refinement |
