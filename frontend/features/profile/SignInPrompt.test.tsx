...
vi.mock("./actions", () => ({ startProfileSignIn: vi.fn() }));

import { SignInPrompt } from "./SignInPrompt";

describe("SignInPrompt", () => {
  it("invites the visitor to sign in instead of showing an error or empty profile", async () => {
  ...
  it("renders in Finnish with no a11y violations", async () => {
    ...
    expect(screen.getByText("Kirjaudu sisään nähdäksesi profiilisi")).toBeInTheDocument();
